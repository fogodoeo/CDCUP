...
# 1. JS: getSchedule 함수에서 파르게의 요일 분기 로직을 '월요일 순차발송' 및 '제주 격주 별도관리' 조건으로 정밀 리팩토링
...
print("Success: Updated Parge shipping rules to use sequential dispatch phrasing and separate Jeju bi-weekly warnings!")
